...
from .misc import standardize_all_variables, df_print, get_matplotlib
from .model import construct_model, model_fit
from .inferences import compile_inferences
...
class CausalImpact:
    ...
    def _align_periods_dtypes(pre_period, post_period, data):
        ...
        # is_datetime_or_timedelta_dtype deprecated
    ...
    def summary(self, output="summary", width=120, path=None):
        ...
        # calculate z score
        z_score = (mean_pred-mean_resp) / std_pred
        # pvalue from zscore
